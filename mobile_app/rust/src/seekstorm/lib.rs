...
//!
//! let index_path=PathBuf::new("C:/index/");
//! let schema_json = r#"
...
//! use std::path::PathBuf;
//!
//! let file_path=PathBuf::new("wiki-articles.json");
...
//!
//! let file_path=PathBuf::new("C:/Users/johndoe/Downloads");
...
//!
//! let file_path=PathBuf::new("C:/test.pdf");
