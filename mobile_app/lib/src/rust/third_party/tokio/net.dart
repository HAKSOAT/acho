...
import 'net/tcp/split_owned.dart';
import 'net/udp.dart';
import 'net/unix.dart';
import 'net/unix/datagram/socket.dart';
import 'net/unix/listener.dart';
import 'net/unix/pipe.dart';
...
abstract class TcpSocket implements RustOpaqueInterface {
  ...
  /// }
  /// ```
  Future<void> setReuseport({required bool reuseport});
  ...
  Future<void> setTclassV6({required int tclass});
  ...
  Future<void> setTosV4({required int tos});
...
abstract class UdpSocket implements RustOpaqueInterface {
  ...
  /// [packet injection attack]: https://en.wikipedia.org/wiki/Packet_injection
  Future<PollResult> pollPeek({required Context cx, required ReadBuf buf});
  ...
  /// [packet injection attack]: https://en.wikipedia.org/wiki/Packet_injection
  Future<BigInt> tryPeek({required U8 buf});
...
// Rust type: RustOpaqueMoi<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<UnixDatagram>>
abstract class UnixDatagram implements RustOpaqueInterface {
  ...
  /// # }
  /// ```
  static Future<UnixDatagram> fromStd({required UnixDatagram datagram}) =>
      RustLib.instance.api.tokioNetUnixDatagramFromStd(datagram: datagram);
  ...
  /// # }
  /// ```
  static Future<(UnixDatagram, UnixDatagram)> pair() =>
      RustLib.instance.api.tokioNetUnixDatagramPair();
  ...
  /// # }
  /// ```
  Future<void> shutdown({required Shutdown how});
  ...
  /// # }
  /// ```
  static Future<UnixDatagram> unbound() =>
      RustLib.instance.api.tokioNetUnixDatagramUnbound();
...
// Rust type: RustOpaqueMoi<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<UnixListener>>
abstract class UnixListener implements RustOpaqueInterface {
  ...
  /// completes first, then it is guaranteed that no new connections were
  /// accepted by this method.
  Future<(UnixStream, SocketAddr)> accept();
  ...
  /// from a future driven by a tokio runtime, otherwise runtime can be set
  /// explicitly with [`Runtime::enter`](crate::runtime::Runtime::enter) function.
  static Future<UnixListener> fromStd({required UnixListener listener}) =>
      RustLib.instance.api.tokioNetUnixListenerFromStd(listener: listener);
  ...
  /// to `poll_accept`, only the `Waker` from the `Context` passed to the most
  /// recent call is scheduled to receive a wakeup.
  Future<PollResultUnixStreamSocketAddr> pollAccept({required Context cx});

  /// Returns the value of the `SO_ERROR` option.
  Future<Error?> takeError();
}

// Rust type: RustOpaqueMoi<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<UnixSocket>>
abstract class UnixSocket implements RustOpaqueInterface {
  ...
  Future<UnixListener> listen({required int backlog});
  ...
  /// encountered, it is returned instead.
  static Future<UnixSocket> newDatagram() =>
      RustLib.instance.api.tokioNetUnixSocketNewDatagram();
  ...
  /// On success, the newly created [`UnixSocket`] is returned. If an error is
  /// encountered, it is returned instead.
  static Future<UnixSocket> newStream() =>
      RustLib.instance.api.tokioNetUnixSocketNewStream();
}

// Rust type: RustOpaqueMoi<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<UnixStream>>
abstract class UnixStream implements RustOpaqueInterface {
  ...
  /// from a future driven by a tokio runtime, otherwise runtime can be set
  /// explicitly with [`Runtime::enter`](crate::runtime::Runtime::enter) function.
  static Future<UnixStream> fromStd({required UnixStream stream}) =>
      RustLib.instance.api.tokioNetUnixStreamFromStd(stream: stream);
  ...
  static Future<(UnixStream, UnixStream)> pair() =>
      RustLib.instance.api.tokioNetUnixStreamPair();
